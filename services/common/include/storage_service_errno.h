...
enum ErrNo {
    ...
    E_DIR_FILE_MANAGER = STORAGE_SERVICE_SYS_CAP_TAG + 730,
    E_DIR_VIRTUAL = STORAGE_SERVICE_SYS_CAP_TAG + 731,
    E_DIR_HMDFS = STORAGE_SERVICE_SYS_CAP_TAG + 732,
    E_DIR_SA = STORAGE_SERVICE_SYS_CAP_TAG + 733,
    E_DIR_APPDATA = STORAGE_SERVICE_SYS_CAP_TAG + 734,
    E_DIR_APPDATA_OTHER = STORAGE_SERVICE_SYS_CAP_TAG + 735,
    E_DIR_APPDATA_FILEMGR = STORAGE_SERVICE_SYS_CAP_TAG + 736,
