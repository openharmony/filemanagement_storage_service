...
enum ErrNo {
    ...
    E_READMETADATA = STORAGE_SERVICE_SYS_CAP_TAG + 1710,
    E_UNSUPPORTED = STORAGE_SERVICE_SYS_CAP_TAG + 1711,
    E_CHECK = STORAGE_SERVICE_SYS_CAP_TAG + 1712,
    E_VOLUMEEX_IS_NULLPTR = STORAGE_SERVICE_SYS_CAP_TAG + 1713,
