...
HWTEST_F(IsoOperatorTest, IsoOperator_DoCDBurn_NoSpaceLeftOnDisk, TestSize.Level1)
{
    IsoOperator op;
    BurnOptions opts;
    opts.isIsoImage = true;
...
HWTEST_F(IsoOperatorTest, IsoOperator_DoDVDBurn_NoSpaceLeftOnDevice, TestSize.Level1)
{
    IsoOperator op;
    BurnOptions opts;
    opts.burnPath = "/data/burn";
