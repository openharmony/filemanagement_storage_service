...
HWTEST_F(StorageDaemonProviderTest, StorageDaemonProviderTest_UpdateUseAuthWithRecoveryKey_001, TestSize.Level1)
{
    ...
    int32_t ret =
        storageDaemonProviderTest_->UpdateUseAuthWithRecoveryKey(authToken, newSecret, secureUid,
...
HWTEST_F(StorageDaemonProviderTest, StorageDaemonProviderTest_GetBundleStatsForIncrease_001, TestSize.Level1)
{
    ...
    int32_t result = storageDaemonProviderTest_->GetBundleStatsForIncrease(StorageTest::USER_ID1, bundleNames,
                                                                           incrementalBackTimes, pkgFileSizes,
                                                                           incPkgFileSizes);
    EXPECT_NE(result, E_ERR);
