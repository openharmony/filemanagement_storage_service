...
public:
    ...
    MOCK_METHOD4(CreateShareFile, int32_t (const FileRawData&, uint32_t, uint32_t, std::vector<int32_t> &));
    MOCK_METHOD2(DeleteShareFile, int32_t (uint32_t, const FileRawData&));
