...
public:
    ...
    MOCK_METHOD2(MountDlpFuse, int32_t (const std::string &, int32_t &));
    MOCK_METHOD1(UMountDlpFuse, int32_t (const std::string &));
    ...
    MOCK_METHOD1(UMountDisShareFile, int32_t ((const std::vector<std::string>&)));
