...
public:
    ...
    virtual int ForkExecToFile(std::vector<std::string> &cmd, const std::string &outputFilePath,
        std::vector<std::string> *output = nullptr) = 0;
...
public:
    ...
    MOCK_METHOD3(ForkExecToFile, int(std::vector<std::string> &cmd, const std::string &outputFilePath,
