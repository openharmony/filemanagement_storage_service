 ...
 */
#ifndef STORAGE_DAEMON_KEY_MANAGER_EXT_MOCK_H
#define STORAGE_DAEMON_KEY_MANAGER_EXT_MOCK_H
...
class IKeyManagerExtMock {
public:
    virtual ~IKeyManagerExtMock() = default;
public:
...
class KeyManagerExtMock : public IKeyManagerExtMock {
public:
