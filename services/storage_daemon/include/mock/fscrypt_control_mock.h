 ...
 */
#ifndef STORAGE_DAEMON_FSCRYT_CONTROL_MOCK_H
#define STORAGE_DAEMON_FSCRYT_CONTROL_MOCK_H
...
class IFscryptControlMoc {
public:
    virtual ~IFscryptControlMoc() = default;
public:
...
class FscryptControlMoc : public IFscryptControlMoc {
public:
