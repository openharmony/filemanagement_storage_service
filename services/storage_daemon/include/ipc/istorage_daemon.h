...
public:
    ...
    virtual int32_t UpdateKeyContext(uint32_t userId, bool needRemoveTmpKey = false) = 0;
    ...
    virtual int32_t GenerateAppkey(uint32_t userId, uint32_t hashId, std::string &keyId, bool needReSet = false) = 0;
