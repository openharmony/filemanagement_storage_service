...
#ifndef OHOS_STORAGE_DAEMON_HMFS_OPERATOR_H
#define OHOS_STORAGE_DAEMON_HMFS_OPERATOR_H
...
class HmfsOperator : public IVolumeOperator {
public:
    ...
    int32_t SetLabel(const std::string &devPath, const std::string &label) override;
};

} // namespace StorageDaemon
} // namespace OHOS

#endif // OHOS_STORAGE_DAEMON_HMFS_OPERATOR_H