...
#ifndef OHOS_STORAGE_DAEMON_EXFAT_OPERATOR_H
#define OHOS_STORAGE_DAEMON_EXFAT_OPERATOR_H
...
class ExfatOperator : public IVolumeOperator {
public:
    ExfatOperator() = default;
    ~ExfatOperator() override = default;
...
#endif // OHOS_STORAGE_DAEMON_EXFAT_OPERATOR_H
