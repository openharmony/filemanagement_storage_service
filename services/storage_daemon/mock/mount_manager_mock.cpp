                                            ...
                                            int32_t &devFd)
{
    ...
    return IMountManagerMoc::mountManagerMoc->MountDlpFuseDevice(dstPath1, dstPath2, devFd);
}
                                            ...
                                            const std::string &dstPath2)
{
    ...
    return IMountManagerMoc::mountManagerMoc->UMountDlpFuseDevice(dstPath1, dstPath2);
}
