...
#ifndef STORAGE_SPACE_MANAGER_SERVICE_BUNDLE_MANAGER_ADAPTER_PROXY_H
#define STORAGE_SPACE_MANAGER_SERVICE_BUNDLE_MANAGER_ADAPTER_PROXY_H
...
public:
    ...
    virtual ErrCode GetApplicationInfosV9(int32_t flags, int32_t userId,
        std::vector<ApplicationInfo> &appInfos) override;

    virtual ErrCode CleanBundlePartialCacheAutomatic(const CleanCacheInfo &cacheInfo, uint64_t &beforeCleanedSize,
        uint64_t &afterCleanedSize) override;
...
#endif // STORAGE_SPACE_MANAGER_SERVICE_BUNDLE_MANAGER_ADAPTER_PROXY_H
