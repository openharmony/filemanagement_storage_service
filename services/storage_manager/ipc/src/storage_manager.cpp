...
{
#ifdef STORAGE_STATISTICS_MANAGER
    LOGI("StorageManger::getFreeSizeOfVolume start, volumeUuid: %{public}s", GetAnonyString(volumeUuid).c_str());
...
{
#ifdef STORAGE_STATISTICS_MANAGER
    LOGI("StorageManger::getTotalSizeOfVolume start, volumeUuid: %{public}s", GetAnonyString(volumeUuid).c_str());
    std::shared_ptr<VolumeStorageStatusService> volumeStatsManager =
        DelayedSingleton<VolumeStorageStatusService>::GetInstance();
...
{
#ifdef EXTERNAL_STORAGE_MANAGER
    LOGI("StorageManger::GetVolumeByUuid start, uuid: %{public}s", GetAnonyString(fsUuid).c_str());
...
{
#ifdef EXTERNAL_STORAGE_MANAGER
    LOGI("StorageManger::SetVolumeDescription start, uuid: %{public}s", GetAnonyString(fsUuid).c_str());
