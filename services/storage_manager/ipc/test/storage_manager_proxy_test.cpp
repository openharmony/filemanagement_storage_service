...
/**
 * @tc.number: SUB_STORAGE_Storage_manager_proxy_QueryUsbIsInUse_0000
 * @tc.name: Storage_manager_proxy_QueryUsbIsInUse_0000
 ...
 */
HWTEST_F(StorageManagerProxyTest, Storage_manager_proxy_QueryUsbIsInUse_0000, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-begin Storage_manager_proxy_QueryUsbIsInUse_0000";
    ASSERT_TRUE(mock_ != nullptr) << "StorageManagerServiceMock failed";
    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Invoke(mock_.GetRefPtr(), &StorageManagerServiceMock::InvokeSendRequest));
    ...
    bool isInUse = true;
    int64_t result = proxy_->QueryUsbIsInUse(diskPath, isInUse);
    EXPECT_EQ(result, E_OK);

    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Return(E_WRITE_PARCEL_ERR));
    result = proxy_->QueryUsbIsInUse(diskPath, isInUse);
    EXPECT_EQ(result, E_WRITE_PARCEL_ERR);
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-end Storage_manager_proxy_QueryUsbIsInUse_0000";
}
...
/**
 * @tc.number: SUB_STORAGE_Storage_manager_proxy_ResetSecretWithRecoveryKey_0000
 * @tc.name: Storage_manager_proxy_ResetSecretWithRecoveryKey_0000
 ...
 * @tc.require: AR000H0F7I
 */
HWTEST_F(StorageManagerProxyTest, Storage_manager_proxy_ResetSecretWithRecoveryKey_0000, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-begin Storage_manager_proxy_ResetSecretWithRecoveryKey_0000";
    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Invoke(mock_.GetRefPtr(), &StorageManagerServiceMock::InvokeSendRequest));
    uint32_t userId = 100;
    uint32_t rkType = 0;
    uint32_t result = proxy_->ResetSecretWithRecoveryKey(userId, rkType, {});
    EXPECT_EQ(result, E_OK);

    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Return(E_WRITE_PARCEL_ERR));
    result = proxy_->ResetSecretWithRecoveryKey(userId, rkType, {});
    EXPECT_EQ(result, E_WRITE_PARCEL_ERR);
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-end Storage_manager_proxy_ResetSecretWithRecoveryKey_0000";
}
...
/**
 * @tc.number: SUB_STORAGE_Storage_manager_proxy_GetUserNeedActiveStatus_0000
 * @tc.name: Storage_manager_proxy_GetUserNeedActiveStatus_0000
 * @tc.desc: Test function of GetUserNeedActiveStatus interface for SUCCESS.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
HWTEST_F(StorageManagerProxyTest, Storage_manager_proxy_GetUserNeedActiveStatus_0000, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-begin Storage_manager_proxy_GetUserNeedActiveStatus_0000";
    ASSERT_TRUE(mock_ != nullptr) << "StorageManagerServiceMock failed";
    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Invoke(mock_.GetRefPtr(), &StorageManagerServiceMock::InvokeSendRequest));
    ...
    ASSERT_TRUE(proxy_ != nullptr) << "StorageManagerProxy failed";
    uint32_t result = proxy_->GetUserNeedActiveStatus(userId, needActive);
    EXPECT_EQ(result, E_OK);

    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Return(E_WRITE_PARCEL_ERR));
    result = proxy_->GetUserNeedActiveStatus(userId, needActive);
    EXPECT_EQ(result, E_WRITE_PARCEL_ERR);
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-end Storage_manager_proxy_GetUserNeedActiveStatus_0000";
}

/**
 * @tc.number: SUB_STORAGE_Storage_manager_proxy_MountFileMgrFuse_0000
 * @tc.name: Storage_manager_proxy_MountFileMgrFuse_0000
 * @tc.desc: Test function of MountFileMgrFuse interface for SUCCESS.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
HWTEST_F(StorageManagerProxyTest, Storage_manager_proxy_MountFileMgrFuse_0000, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-begin Storage_manager_proxy_MountFileMgrFuse_0000";
    ASSERT_TRUE(mock_ != nullptr) << "StorageManagerServiceMock failed";
    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Invoke(mock_.GetRefPtr(), &StorageManagerServiceMock::InvokeSendRequest));
    int32_t userId = 100;
    std::string path = "/mnt/data/100/smb/testStorageManagerProxy";
    int32_t fuseFd = -1;
    ASSERT_TRUE(proxy_ != nullptr) << "StorageManagerProxy failed";
    int32_t result = proxy_->MountFileMgrFuse(userId, path, fuseFd);
    EXPECT_EQ(result, E_OK);

    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Return(E_WRITE_PARCEL_ERR));
    result = proxy_->MountFileMgrFuse(userId, path, fuseFd);
    EXPECT_EQ(result, E_WRITE_PARCEL_ERR);
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-end Storage_manager_proxy_MountFileMgrFuse_0000";
}

/**
 * @tc.number: SUB_STORAGE_Storage_manager_proxy_UMountFileMgrFuse_0000
 * @tc.name: Storage_manager_proxy_UMountFileMgrFuse_0000
 * @tc.desc: Test function of UMountFileMgrFuse interface for SUCCESS.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
HWTEST_F(StorageManagerProxyTest, Storage_manager_proxy_UMountFileMgrFuse_0000, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-begin Storage_manager_proxy_UMountFileMgrFuse_0000";
    ASSERT_TRUE(mock_ != nullptr) << "StorageManagerServiceMock failed";
    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Invoke(mock_.GetRefPtr(), &StorageManagerServiceMock::InvokeSendRequest));
    ...
    std::string path = "/mnt/data/100/smb/testStorageManagerProxy";
    ASSERT_TRUE(proxy_ != nullptr) << "StorageManagerProxy failed";
    int32_t result = proxy_->UMountFileMgrFuse(userId, path);
    EXPECT_EQ(result, E_OK);

    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Return(E_WRITE_PARCEL_ERR));
    result = proxy_->UMountFileMgrFuse(userId, path);
    EXPECT_EQ(result, E_WRITE_PARCEL_ERR);
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-end Storage_manager_proxy_UMountFileMgrFuse_0000";
}

/**
 * @tc.number: SUB_STORAGE_Storage_manager_proxy_IsFileOccupied_0000
 * @tc.name: Storage_manager_proxy_IsFileOccupied_0000
 * @tc.desc: Test function of IsFileOccupied interface for SUCCESS.
 * @tc.size: MEDIUM
 * @tc.type: FUNC
 * @tc.level Level 1
 */
HWTEST_F(StorageManagerProxyTest, SUB_STORAGE_Storage_manager_proxy_IsFileOccupied_0000, testing::ext::TestSize.Level1)
{
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-begin Storage_manager_proxy_IsFileOccupied_0000";
    ASSERT_TRUE(mock_ != nullptr) << "StorageManagerServiceMock failed";
    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Invoke(mock_.GetRefPtr(), &StorageManagerServiceMock::InvokeSendRequest));
    ...
    bool isOccupy = false;
    ASSERT_TRUE(proxy_ != nullptr) << "StorageManagerProxy failed";
    int32_t result = proxy_->IsFileOccupied(path, inputList, outputList, isOccupy);
    EXPECT_EQ(result, E_OK);

    EXPECT_CALL(*mock_, SendRequest(testing::_, testing::_, testing::_, testing::_))
        .Times(1)
        .WillOnce(testing::Return(E_WRITE_PARCEL_ERR));
    result = proxy_->IsFileOccupied(path, inputList, outputList, isOccupy);
    EXPECT_EQ(result, E_WRITE_PARCEL_ERR);
    GTEST_LOG_(INFO) << "StorageManagerProxyTest-end Storage_manager_proxy_IsFileOccupied_0000";
}
} // namespace
