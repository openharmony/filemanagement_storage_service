...
public:
    ...
    virtual int32_t MountDlpFuse(const std::string &dstPath1, const std::string &dstPath2,
        int &fd, int32_t &funcResult) override;
    virtual int32_t UMountDlpFuse(const std::string &dstPath1, const std::string &dstPath2,
