 ...
 ***********************************************/
napi_value EncryptedVolumeManagerExport(napi_env env, napi_value exports)
{
...
static napi_module _module = {
    ...
    .nm_flags = 0,
    .nm_filename = nullptr,
    .nm_register_func = EncryptedVolumeManagerExport,
    .nm_modname = "file.encryptedvolumeManager",
    .nm_priv = ((void *)0),
    .reserved = {0}
};
