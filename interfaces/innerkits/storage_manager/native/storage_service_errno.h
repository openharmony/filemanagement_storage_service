...
enum ErrNo {
    ...
    E_CREATE_PARTITION_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1741,
    E_DELETE_PARTITION_NOT_SUPPORT = STORAGE_SERVICE_SYS_CAP_TAG + 1742,
    E_DELETE_PARTITION_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1743,
