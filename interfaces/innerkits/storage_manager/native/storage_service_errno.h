...
enum ErrNo {
    ...
    E_DURATION_EXCEED_THRESH = STORAGE_SERVICE_SYS_CAP_TAG + 21,
    E_CALCULATE_OVERFLOW_UP = STORAGE_SERVICE_SYS_CAP_TAG + 22,
    ...
    E_DELETE_USER_DIR_NOEXIST = STORAGE_SERVICE_SYS_CAP_TAG + 751,
    E_DELETE_USER_DIR_NOTDIR = STORAGE_SERVICE_SYS_CAP_TAG + 752,
