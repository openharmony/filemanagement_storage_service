...
enum ErrNo {
    ...
    E_MOUNT_DLP_FUSE = STORAGE_SERVICE_SYS_CAP_TAG + 759,
    E_UMOUNT_DLP_FUSE = STORAGE_SERVICE_SYS_CAP_TAG + 760,
...
enum JsErrCode {
    ...
    E_JS_FORMAT_PARTITION_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 25,
};
