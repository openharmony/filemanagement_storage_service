...
enum ErrNo {
    ...
    E_MIGRATE_ELX_FAILED = STORAGE_SERVICE_SYS_CAP_TAG + 204,
    ...
    E_INVALID_KEY_ID_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 402,
    ...
    E_RENAME_FILE_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 416,
    E_DIR_NOT_EMPTY_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 417,
    ...
    E_MOUNT_DLP_FUSE = STORAGE_SERVICE_SYS_CAP_TAG + 751,
    E_UMOUNT_DLP_FUSE = STORAGE_SERVICE_SYS_CAP_TAG + 752,
    ...
    E_MOUNT_AGAIN_FAILED = STORAGE_SERVICE_SYS_CAP_TAG + 758,
    E_APPSPAWN_SECOND_MOUNT = STORAGE_SERVICE_SYS_CAP_TAG + 760,
    E_PUBLISH_COMM_EVENT = STORAGE_SERVICE_SYS_CAP_TAG + 761,
    ...
    E_SET_QUOTA_UID_FAILED = STORAGE_SERVICE_SYS_CAP_TAG + 1227,
    E_SEND_EVENT_TO_CLEAN_CACHE_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1228,
    E_GET_INODE_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1229,
    E_CLEAN_TIME_INTERVAL_NOT_ENOUGH = STORAGE_SERVICE_SYS_CAP_TAG + 1230,
    E_SCAN_RESULT = STORAGE_SERVICE_SYS_CAP_TAG + 1231,
    ...
    E_SET_TOTAL_SECTOR_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1736,
    E_SET_SECTOR_SIZE_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1737,
    E_SET_ALIGN_SECTOR_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1738,
    E_GET_PARTITION_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1739,
    E_CREATE_PARTITION_NOT_SUPPORT = STORAGE_SERVICE_SYS_CAP_TAG + 1740,
    E_CREATE_PARTITION_TIMEOUT = STORAGE_SERVICE_SYS_CAP_TAG + 1741,
    E_CREATE_PARTITION_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1742,
    E_DELETE_PARTITION_NOT_SUPPORT = STORAGE_SERVICE_SYS_CAP_TAG + 1743,
    E_DELETE_PARTITION_TIMEOUT = STORAGE_SERVICE_SYS_CAP_TAG + 1744,
    E_DELETE_PARTITION_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1745,
    E_GET_PARTITION_TIMEOUT = STORAGE_SERVICE_SYS_CAP_TAG + 1746,
    E_SET_USABLE_SECTOR_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1747,
    E_FORMAT_PARTITION_NOT_SUPPORT = STORAGE_SERVICE_SYS_CAP_TAG + 1748,
    E_FORMAT_PARTITION_TIMEOUT = STORAGE_SERVICE_SYS_CAP_TAG + 1749,
    E_FORMAT_PARTITION_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 1750,

    // 刻录错误 13601801 ~ 13601900
    ...
    E_DLOPEN_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 4407,
    E_DLSYM_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 4408,

    // 数据库 13605401
    E_READ_RECORD_FILE_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 5401,
    E_WRITE_RECORD_FILE_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 5402,
    E_PARSE_RECORD_FILE_ERROR = STORAGE_SERVICE_SYS_CAP_TAG + 5403,
};
