 ...
 */
#include "storagemanagerprovidergetallextbundlestats_fuzzer.h"
...
bool GetAllExtBundleStats(const uint8_t *data, size_t size)
{
    uint32_t code = static_cast<uint32_t>(IStorageManagerIpcCode::COMMAND_GET_ALL_EXT_BUNDLE_STATS);
    MessageParcel datas;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    GetAllExtBundleStats(data, size);
    return 0;
}
