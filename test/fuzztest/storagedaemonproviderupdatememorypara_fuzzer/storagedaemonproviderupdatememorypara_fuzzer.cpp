 ...
 */
#include "storagedaemonproviderupdatememorypara_fuzzer.h"
...
bool StorageDaemonProviderUpdateMemoryParaFuzzTest(const uint8_t *data, size_t size)
{
...
{
    OHOS::StorageDaemonProviderUpdateMemoryParaFuzzTest(data, size);
    return 0;
}
