 ...
 */
#include "storagemanagerprovidergettotalinodes_fuzzer.h"
...
void GetTotalInodes(const uint8_t *data, size_t size)
{
    uint32_t code = static_cast<uint32_t>(IStorageManagerIpcCode::COMMAND_GET_TOTAL_INODES);
    MessageParcel datas;
