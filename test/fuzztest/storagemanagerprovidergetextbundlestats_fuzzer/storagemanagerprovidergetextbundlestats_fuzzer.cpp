 ...
 */
#include "storagemanagerprovidergetextbundlestats_fuzzer.h"
...
bool GetExtBundleStats(const uint8_t *data, size_t size)
{
    uint32_t code = static_cast<uint32_t>(IStorageManagerIpcCode::COMMAND_GET_EXT_BUNDLE_STATS);
    MessageParcel datas;
