 ...
 */
#include "storagemanagerprovidergetsystemdatasize_fuzzer.h"
...
void GetSystemDataSize(const uint8_t *data, size_t size)
{
    uint32_t code = static_cast<uint32_t>(IStorageManagerIpcCode::COMMAND_GET_SYSTEM_DATA_SIZE);
    MessageParcel datas;
