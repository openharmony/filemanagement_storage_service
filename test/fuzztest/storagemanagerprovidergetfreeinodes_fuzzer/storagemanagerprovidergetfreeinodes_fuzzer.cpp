 ...
 */
#include "storagemanagerprovidergetfreeinodes_fuzzer.h"
...
void GetFreeInodes(const uint8_t *data, size_t size)
{
    uint32_t code = static_cast<uint32_t>(IStorageManagerIpcCode::COMMAND_GET_FREE_INODES);
    MessageParcel datas;
