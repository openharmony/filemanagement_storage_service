 ...
 */
#include "storagemanagerproviderisosaccountexists_fuzzer.h"
...
{
    uint32_t code = static_cast<uint32_t>(IStorageManagerIpcCode::COMMAND_IS_OS_ACCOUNT_EXISTS);
    MessageParcel datas;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::StorageManager::IsOsAccountExistsFuzzTest(data, size);
    return 0;
}
