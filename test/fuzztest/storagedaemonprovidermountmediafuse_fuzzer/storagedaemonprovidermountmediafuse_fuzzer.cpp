 ...
 */
#include "storagedaemonprovidermountmediafuse_fuzzer.h"
...
bool StorageDaemonProviderMountMediaFuseFuzzTest(const uint8_t *data, size_t size)
{
...
{
    OHOS::StorageDaemonProviderMountMediaFuseFuzzTest(data, size);
    return 0;
}
