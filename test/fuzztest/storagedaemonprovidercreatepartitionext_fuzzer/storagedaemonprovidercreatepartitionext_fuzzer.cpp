 ...
 */
#include "storagedaemonprovidercreatepartitionext_fuzzer.h"
...
bool CreatePartitionExtFuzzTest(const uint8_t *data, size_t size)
{
    ...
    datas.WriteInt64(fdp.ConsumeIntegral<int64_t>());
    datas.WriteInt64(fdp.ConsumeIntegral<int64_t>());
...
{
    OHOS::CreatePartitionExtFuzzTest(data, size);
    return 0;
}
