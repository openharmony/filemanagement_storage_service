 ...
 */
#include "storagemanagerprovidersetextbundlestats_fuzzer.h"
...
bool SetExtBundleStats(const uint8_t *data, size_t size)
{
    uint32_t code = static_cast<uint32_t>(IStorageManagerIpcCode::COMMAND_SET_EXT_BUNDLE_STATS);
    MessageParcel datas;
