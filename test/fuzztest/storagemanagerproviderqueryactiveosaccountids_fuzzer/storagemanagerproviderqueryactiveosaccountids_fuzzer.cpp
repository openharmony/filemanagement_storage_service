 ...
 */
#include "storagemanagerproviderqueryactiveosaccountids_fuzzer.h"
...
{
    uint32_t code = static_cast<uint32_t>(IStorageManagerIpcCode::COMMAND_QUERY_ACTIVE_OS_ACCOUNT_IDS);
    MessageParcel datas;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::StorageManager::QueryActiveOsAccountIdsFuzzTest(data, size);
    return 0;
}
