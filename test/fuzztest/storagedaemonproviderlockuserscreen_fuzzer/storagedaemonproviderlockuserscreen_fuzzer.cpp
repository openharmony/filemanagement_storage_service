 ...
 */
#include "storagedaemonproviderlockuserscreen_fuzzer.h"
...
bool StorageDaemonProviderLockUserScreenFuzzTest(const uint8_t *data, size_t size)
{
...
{
    OHOS::StorageDaemonProviderLockUserScreenFuzzTest(data, size);
    return 0;
}
