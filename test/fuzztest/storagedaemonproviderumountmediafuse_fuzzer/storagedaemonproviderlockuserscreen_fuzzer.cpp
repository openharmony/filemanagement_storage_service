 ...
 */
#include "storagedaemonproviderumountmediafuse_fuzzer.h"
...
bool StorageDaemonProviderUMountMediaFuseFuzzTest(const uint8_t *data, size_t size)
{
...
{
    OHOS::StorageDaemonProviderUMountMediaFuseFuzzTest(data, size);
    return 0;
}
